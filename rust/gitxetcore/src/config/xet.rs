...
use super::upstream_config::UpstreamXetRepo;
...
impl XetConfig {
    ...
    //     cfg_to_xetconfig(cfg, None, gitpath).map_err(ConfigError::into)
    // }
    // 
    ...
    //     cfg_to_xetconfig(self.origin_cfg.clone(), None, gitpath).map_err(ConfigError::into)
    // }
    // 
    ...
    //     // overrides: Option<CliOverrides>,
    // ) -> Result<XetConfig, GitXetRepoError> {
    //     cfg_to_xetconfig_with_repoinfo(self.origin_cfg.clone(), None, repo_info)
    ...
    //     // overrides: Option<CliOverrides>,
    // ) -> Result<XetConfig, GitXetRepoError> {
    //     self.try_with_xetblob_path(xetblob, None)
    //         .map_err(ConfigError::into)
    // }
    // 
    ...
    pub async fn cas_endpoint(&self) -> Result<String, ConfigError> {
        ...
        // override '--cas' to provide a URL, or export  in your terminal.
        // 
    ...
    // 
    //     use xet_config::{Cache, PROD_CAS_ENDPOINT, User};
    // 
