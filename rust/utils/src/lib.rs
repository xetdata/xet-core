...
impl TryFrom<u8> for CompressionScheme {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            x if x == CompressionScheme::None as u8 => Ok(CompressionScheme::None),
            x if x == CompressionScheme::Lz4 as u8 => Ok(CompressionScheme::Lz4),
            _ => Err(()),
        }
    }
}

impl TryFrom<String> for CompressionScheme {
    type Error = ();
